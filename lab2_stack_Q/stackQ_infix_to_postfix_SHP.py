'''<Lab 4: Infix to postfix conversion>
Read an infix expression from the given input file, and translate it to the postfix expression by using Stack ADT.
1. Input
Obtain an infix expression from the given input file (expr_input.txt).
The expression ends with #. A detail specification of operators $ operands is provided below.
